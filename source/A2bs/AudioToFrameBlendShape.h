...
class API AudioToFlameBlendShape {
public:
  AudioToFlameBlendShape(const std::string &local_resource_root,
                         const std::string &mnn_mmap_dir,
                         const bool do_verts2flame, const int ori_fps,
                         const int out_fps, const int num_exp = 50);
