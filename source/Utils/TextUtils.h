...
#ifdef _MSC_VER
#define MIRROR_STRTOLL(cur_cstr, end_cstr) _strtoi64(cur_cstr, end_cstr, 10);
#else
#define MIRROR_STRTOLL(cur_cstr, end_cstr) strtoll(cur_cstr, end_cstr, 10);
#endif
...
bool ConvertStringToInteger(const std::string &str, Int *out) {
  ...
  char *end = nullptr;
  errno = 0;
  int i = MIRROR_STRTOLL(this_str, &end);
  if (end != this_str) {
