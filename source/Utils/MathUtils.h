...
NAMESPACE_BEGIN
// logf(FLT_EPSILON)
#define SHERPA_MNN_MIN_LOG_DIFF_FLOAT -15.9423847198486328125f

// log(DBL_EPSILON)
#define SHERPA_MNN_MIN_LOG_DIFF_DOUBLE \
...
struct LogAdd<double> {
  double operator() (double x, double y) const {
    ...
    if (diff >= SHERPA_MNN_MIN_LOG_DIFF_DOUBLE) {
      double res;
